...
router.post('/settings/upload-logo', checkIfAdmin, SettingsController.uploadLogo);
...
router.post('/posts/create', checkIfUser, PostController.create);
router.put('/posts/update', checkIfUser, PostController.update);
